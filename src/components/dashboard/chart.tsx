...
export default function Chart({data}: {data: resultType}) {
  ...
  return (
    <>
      <main className="flex flex-col justify-center min-w-[100%]">
        <div className="flex gap-4 p-2 mt-4 mb-4">
           {
...
function CustomChartButton({children, scope}: {children: any, scope: string}) { 
    ...
    return (
     <>
        <Link 
        className={`p-3 border-[1px] border-[#EFF1F6] text-[14px] text-[#31373D] font-[500] rounded-full 
